...
import { Link, Menu, X, LogOut, User } from 'lucide-react';
            ...
            {currentUser ? (
              <div className="flex items-center space-x-4">
                ...
                <button
                  ...
                  className="flex items-center space-x-2 border border-gray-600 px-4 py-2 rounded-lg font-semibold hover:bg-gray-800/50 hover:border-orange-400 transition-all duration-300 hover:scale-105"
                >
              ...
              <div className="flex items-center space-x-4">
                ...
                <button
                  ...
                  className="bg-gradient-to-r from-orange-500 to-orange-600 px-6 py-2 rounded-lg font-semibold hover:shadow-xl hover:shadow-orange-500/50 transition-all duration-300 hover:scale-105 hover:-translate-y-1"
                >
                  Get Started
                </button>
              </div>
            ...
            <div className="flex flex-col space-y-4">
              ...
              {currentUser ? (
                <div className="flex flex-col space-y-4 pt-4 border-t border-gray-700">
                  ...
                  <button
                    onClick={handleLogout}
                    className="flex items-center space-x-2 border border-gray-600 px-4 py-2 rounded-lg font-semibold text-left hover:bg-gray-800/50"
                  >
                    <LogOut className="h-4 w-4" />
                    <span>Logout</span>
                  </button>
                ...
                <div className="flex flex-col space-y-4 pt-4 border-t border-gray-700">
                  ...
                  <button
                    onClick={() => setShowSignupModal(true)}
                    className="bg-gradient-to-r from-orange-500 to-orange-600 px-6 py-2 rounded-lg font-semibold text-left"
                  >
                    Get Started
                  </button>
                </div>
